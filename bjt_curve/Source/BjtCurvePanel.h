...
class BjtCurvePanel final : public juce::Component, private juce::AsyncUpdater
{
 public:
  BjtCurvePanel();
  ~BjtCurvePanel() override;

  void setModel(bjt_curve::BjtModelKind model);
 ...
 private:
  ...
  {
    bjt_curve::BjtModelKind model{bjt_curve::BjtModelKind::IdealNpn};
  ...
  bjt_curve::BjtModelKind model_{bjt_curve::BjtModelKind::IdealNpn};
