...
void EffectFooterComponent::lookAndFeelChanged()
{
...
void EffectFooterComponent::paint (juce::Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
}

void EffectFooterComponent::resized()
{
...
int EffectFooterComponent::getMinimumContentWidth (int heightHint)
{
