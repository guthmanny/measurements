/*
  Custom Standalone entry point for Audio Effect Template.
...
class TemplateStandaloneApp : public juce::JUCEApplication
{
public:
    TemplateStandaloneApp()
    {
...
{
    return new TemplateStandaloneApp();
}
