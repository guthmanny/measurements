...
ChorusHeaderComponent::ChorusHeaderComponent()
{
...
ChorusHeaderComponent::~ChorusHeaderComponent() = default;

void ChorusHeaderComponent::applyMeterSettings (int displayRangeDbSpanIn)
{
...
void ChorusHeaderComponent::setMeterDisplayLevels (float monoNorm, float leftNorm, float rightNorm)
{
...
void ChorusHeaderComponent::lookAndFeelChanged()
{
...
void ChorusHeaderComponent::paint (juce::Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (juce::ResizableWindow::backgroundColourId));
}

void ChorusHeaderComponent::resized()
{
    using juce::FlexBox;
    using juce::FlexItem;
...
int ChorusHeaderComponent::getMinimumContentWidth (int heightHint)
{
